...
# Elements of tuples cannot be changed after creation.
...
team_a.add("Bob")
print(team_a)
# Sets only store unique items and if we try adding a duplicate item it is ignored by python
...
avg_score=sum(report["marks"])/len(report["marks"])
