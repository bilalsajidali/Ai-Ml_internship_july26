...
# YOUR CODE HERE
"""
Python is a programming language used in various workflows such as web development, data analysis, 
artificial intelligence, automations etc. It is very beginer friendly to learn.
"""
