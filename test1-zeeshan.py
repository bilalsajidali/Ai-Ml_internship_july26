...
print("one", "two", "three", sep=" | ") 
        # <-- replace ??? with correct separator
...
# YOUR CODE HERE
"""python is a very popular programming language that is used for wed development , 
data analysis, artificial intelligence,machine learning. It is known for its simplicity and readability, 
it is easy to learn and understand, making it a great choice for beginners."""
...
# YOUR CODE HERE
name = "Zeeshan"
#here name is a variable that stores the string value "zeeshan" 

# Q10. Create variable  age  with your age as a number.
# YOUR CODE HERE
age = 25
#here age is a variable that stores the integer value 25

# Q11. Create variable  is_intern  and set it to True.
# YOUR CODE HERE
is_intern = True
#here is_intern is a variable that stores the boolean value True
...
print("you are" + str(user_age) + "years old")  # fixed version using str() casting
...
# YOUR CODE HERE
print(sentence.count("a"))  # case-sensitive count of "a"
