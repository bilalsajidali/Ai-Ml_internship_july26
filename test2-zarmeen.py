...
#    - Run the file when done: python test2.py
# ============================================================
...
# YOUR CODE HERE
cities = ["izmir","cairo","muscat","baghdad","rome"]
...
# error name: tuple object does not support item asignment
# tuples in python are immutable, tuples cannot be changed after creation
...
# YOUR CODE HERE
counts_tuple.count("blue")

# Q38. Find the index of "green" in  counts_tuple.
# YOUR CODE HERE
counts_tuple.index("green")
...
team_a.add("Bob")
print(team_a)
#sets are used to store unique values that is why duplicated don't appear in sets
...
student_backup.update({"age" : 99})
print(f"student dict age: {student["age"]}")
print(f"student_backup dict age: {student_backup["age"]}")
...
print(f"Subjects  :   {report["subject"]}")
